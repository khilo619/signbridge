"""Router for the 100-class (full) sign recognition API."""
...
router = APIRouter(prefix="/sign", tags=["sign-full"])
...
async def predict_sign(
    ...
    """Predict the sign in an uploaded video clip using the 100-class model.
